...
const HomePage = () => {
  ...
  return (
    <PageLayout showHeader={false} backgroundVariant="default">
      <PageHeader customTitle={logoTitle} rightContent={searchButton} />
      ...
      <section className="py-4">
        <div className="flex items-center justify-between px-4 mb-3">
          <SectionTitle className="mb-0">Now Showing</SectionTitle>
      ...
      <section className="px-4 py-3 space-y-4">
        <div>
          <SectionTitle variant="small" className="mb-2">Genre</SectionTitle>
          <FilterChips
            items={genres}
        ...
        <div>
          <SectionTitle variant="small" className="mb-2">Language</SectionTitle>
          <FilterChips
            items={languages}
      ...
      <section className="px-4 py-4">
        <div className="flex items-center justify-between mb-3">
          <SectionTitle className="mb-0">All Movies</SectionTitle>
          ...
          <div className="fixed inset-x-0 bottom-0 z-50 animate-slide-up">
            <div className="glass-dark border-t border-border/30 rounded-t-3xl max-h-[75vh] overflow-y-auto pb-24">
              ...
              <div className="px-4 py-4 border-b border-border/20">
                <SectionTitle variant="small" className="mb-2">Select Date</SectionTitle>
                <DateSelector selectedDate={selectedDate} onDateSelect={setSelectedDate} />
              </div>

              {/* Showtimes */}
              <div className="p-4 space-y-5">
                <SectionTitle variant="small" className="mb-0">Available Showtimes</SectionTitle>
